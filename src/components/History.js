                                ...
                                <>
                                    {
                                        history.status === 'In' 
                                            ?   (
                                                    <IncomeHistory className="cool" onClick={() => deleteHistory("inc", history.id, history.amount)}>
                                                        <HistoryTitle> {history.title} </HistoryTitle>

                                                        <HistoryNumber> ${history.amount} </HistoryNumber>
                                                    </IncomeHistory> 
                                                )
                                            :   (
                                                    <ExpencesHistory className="cool" onClick={() => deleteHistory("exp", history.id, history.amount)}>
                                                        <HistoryTitle> {history.title} </HistoryTitle>
